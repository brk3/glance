...
from glance.common.memcached import MemcacheRing


class MemcacheMiddleware(object):
    """
    Caching middleware that manages caching in glance.
    """
    ...
    def __call__(self, env, start_response):
        env['glance.cache'] = self.memcache
